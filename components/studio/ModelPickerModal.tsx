...
export function ModelPickerModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] grid place-items-center bg-black/60 backdrop-blur-sm" onMouseDown={onClose}>
      <div
        className="studio-node flex max-h-[80vh] w-[560px] max-w-[92vw] flex-col rounded-2xl border border-white/10 bg-[#191919]/95 p-4 shadow-[0_24px_80px_rgba(0,0,0,0.7)]"
